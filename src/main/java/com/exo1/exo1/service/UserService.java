...
public class UserService {
    ...
    public List<UserDto> findAll() {
        return userMapper.toDtos(userRepository.findAllWithAssociations());
    }

    public List<UserDto> findAllWithPagination(Pageable pageable) {
        Page<User> usersPage = userRepository.findAllWithAssociationsPagination(pageable);
        return usersPage.map(userMapper::toDto).getContent();
    }
