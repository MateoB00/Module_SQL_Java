...
@RestController
@RequestMapping("/projets-task-count")
public class ProjetTaskCountController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ProjetTaskCountDto> findByProjetId(@PathVariable Long id)
    {
        return ResponseEntity.ok(projetTaskCountService.findById(id));
    }
}
